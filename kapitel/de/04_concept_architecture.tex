...
\end{verbatim}
  ...
  Beobachter-Schnittstelle. „SearchEngine" ist die Such-API-Sicht desselben Lebewesens, gemessen
  über genau diese eine Beobachter-Schnittstelle über alle neunzehn Organe. Es gibt somit eine
