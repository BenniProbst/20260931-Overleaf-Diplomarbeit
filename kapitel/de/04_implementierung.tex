...
\begin{tikzpicture}[font=\footnotesize,>=Stealth,
  ...
  \node[font=\tiny,anchor=south] at ([xshift=3.95cm,yshift=1pt]bp){Standardweg ohne Hybrid: CEB-Prüf-Dock $\to$ Tier-Binary direkt; mit Hybrid: Prüf-Dock $\to$ Mux $\to$ Dock-Slot $\to$ Tier-Binary};
