...
\end{itemize}
Die Vierer-Ordnung des Codes ist nicht die Repository-Grenze, sondern die \emph{Träger-Stufenkette}
Planer $\to$ CEB $\to$ Tier $\to$ Hybrid (Abschnitt~\ref{sec:anatomy-levels}); der Quellbaum bildet sie
unter \texttt{libs/traeger} als vier Unterprojekte in Stufenform ab, wobei Stufe $N+1$ nur an Stufe $N$
hängt. Umsetzungsstand: Die Unterprojekte sind ein Gerüst, die Implementierung liegt als Monolith unter
