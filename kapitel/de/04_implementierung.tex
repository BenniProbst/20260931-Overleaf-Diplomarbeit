...
Rückschreib-Methoden, Abschnitt~\ref{sec:impl-system-axes}). Durchführungs-Stand: Die Naht schreibt die
CSV-Projektion als eine flache Datei (\texttt{projektion\_\allowbreak{}oeffnen} in
\texttt{ergebnis\_\allowbreak{}mappe\_\allowbreak{}naht}); die Baumform ist ein offener Bauposten. Die
...
Blatt), im Durchführungs-Stand als eine flache Datei geschrieben (die Baumform ist ein offener Bauposten;
...
%% CSV-Form ihr aus ihr erzeugter Baum aus CSV-Dateien (kein einzelnes Kind-Dokument); Durchführungs-Stand
%% an dieser einen Stelle (E1-Prüfung an der flachen CSV-Projektion, xlsx-Prüfung und Baumform als Posten).
...
der Mappe oder zusätzlich zu ihr am selben Ziel liegt. Durchführungs-Stand: Die E1-Prüfung liest die
...
der CSV-Ablage sind als Bau-Schritte benannt.
...
oder zusätzlich zu ihr; Durchführungs-Stand: die CSV-Projektion ist als eine flache Datei gebaut, die
Baumform ist ein offener Bauposten).
