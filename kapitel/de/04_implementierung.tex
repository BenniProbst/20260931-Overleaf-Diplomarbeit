...
\begin{tikzpicture}[font=\footnotesize,>=Stealth,
  ...
  \node[st] (s2) at (3.95,0){\textbf{Stufe 2: CEB}\\{\tiny\texttt{comdare-messung-driver}}\\[2pt]{\tiny trägt die Mess-Wahl einkompiliert, permutiert System $\times$ Organ; Legende je Host \texttt{tier:build-batch:\allowbreak<host>}, Testate \texttt{zelle=\allowbreak[d,e,f]\allowbreak[g,h,i]}}};
...
Stufe $N+1$ hängt nur an Stufe $N$; nur die Mess-Testate tragen alle drei Achsen-Klammern. Die Flächen
...
\texttt{zelle=[d,e,f][g,h,i]} tragen und der die Organ-Bau-Volumina intern in Scheiben zu je 4096 Binaries
...
\texttt{zelle=[a,b,c][d,e,f][g,h,i]} tragen (Abbildung~\ref{fig:traeger-stufen}); die Klammern nennen nur
