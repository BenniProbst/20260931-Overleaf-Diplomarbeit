...
unter \texttt{--debug} fährt das Konformitäts-Gate zusätzlich den Genus-Testsatz, und dieser indirekte
...
Zustand; unter \texttt{--debug} fährt das Konformitäts-Gate zusätzlich den Genus-Testsatz, ein indirekter
