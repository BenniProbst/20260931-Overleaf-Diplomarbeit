...
\begin{itemize}
  ...
  (Kompositions-Slots T0--T17) tragen die Binary-Permutation eines in der Forschung verwendeten oder allgemein bekannten Teil-Entwurf Algorithmus, drei System-Haupt-Achsen ---
  Ziel-ISA, Betriebssystem und Erweiterungs-Hardware --- beschreiben die Bau- und Ziel-Plattform,
  und ein eigenständiger Mess-Achsen-Realm hält die Mess-Belange von beidem getrennt; eine optionale neuzehte Achse existiert nur, wenn man IO auf eine Festplatte aktiviert und in den Algorithmus Entwurf mit einbindet.
  ...
  eigenständigem Suchentwurf abdecken. Der XML Enwurf bildet mithilfe der Cache Engine die einzelnen Algorithmus Bestanteile zur Kompilierzeit echt ab und ist damit eine Compiler-Compiler Bauanleitung in einem model-driven Optimierungs-Stack.
  ...
  Cache-Engine-Standard laufen (Abschnitt~\ref{sec:prtart-demo}). Der Einsatz eines Prüflings beweist die vollständige Erweiterbarkeit des Systems zu effizienten Weiterentwicklung neuartiger Ansätze im Umgang mit cache aware Algorithmen und beschleunigter Suche.
  ...
  LaTeX-Tabellen und -Diagramme.
  \item Eine bias-freie Vergleichs-Matrix, die \emph{alle} in der Forschung bekannten Lastprofile gegen \emph{alle}
  rekonstruierten Lebewesen (Entwurfs-Muster getriebene original Paper-Binaries) fährt und so dem methodischen Heimspiel-Bias der Einzelveröffentlichungen begegnet.
