...
und hierarchisches Prefetching~\cite{chen2001prefetch} adressieren jeweils einen separat betrachteten
...
drei getrennte Achsen-Register an --- ein Organ-Achsen-Register, ein System-Achsen-Register und ein
...
Kapitel~\ref{ch:impl}, FF2 in Abschnitt~\ref{sec:measurement-system} und Kapitel~\ref{ch:eval}, FF3 in
Abschnitt~\ref{sec:prtart-demo} und Kapitel~\ref{ch:eval}, FF4 in
Abschnitt~\ref{sec:impl-system-axes}; Kapitel~\ref{ch:conclusion} zieht die Bilanz je Haupt- und
Teilfrage. Die Teilfragen tragen dazu die Kennungen FF0.E, FF1.a, FF1.b, FF2.a, FF2.b, FF2.c, FF3.a,
FF3.b und FF4.E.
\begin{description}
  ...
  NEON/SVE2, RVV) variiert wird --- soweit die Bau-Freigabe der jeweiligen Zielplattform vorliegt
  ...
  gegenüber bis zu sechzehn bei Hankins/Patel~\cite{hankins2003nodesize}) durch achsen-isolierte, unter
  ...
  Verzweigungspunkt am günstigsten, und nach welchen plattform-kalibrierten
  ...
  je Füllstand und Suchtyp --- soll adaptiv gewechselt werden? Der Prüfling schaltet derzeit nach festen
  Dichte-Schwellen von 25, 50 und 75~Prozent um (Abschnitt~\ref{sec:prtart-demo}).
  ...
  erzeugen, und welche können bzw.\ müssen zur Laufzeit gewählt werden (segmentierter
  Permutations-Identifier über die achtzehn Organ-Haupt-Achsen samt Stempel-Einträgen, deren
  Deskriptor-Bits die Meta-Meta-Ebene tragen, adaptive Layout-Selection), ohne die wissenschaftliche
  ...
  Mess-Wahlen laufzeit-variabel bleiben dürfen?
\end{description}
...
\begin{itemize}
  ...
  Organ-Meta-Meta-Achse (Festplatten-IO) tritt hinzu, sobald Platten-IO in den Algorithmus-Entwurf
  eingebunden wird; sie stempelt im Klammer-Anhang der Organ-Zeile und bleibt außerhalb der
  Permutations-Identität. Umgesetzt ist die Matrix mit Boost.MP11-Compile-Time-Typlisten-Bausteinen ---
  ...
  Kapitel~\ref{ch:eval} ausweist --- und drei Granularitäten: Micro-, Makro- und Gesamt-Benchmarking
  ...
  plattformbezogen die Binary-Permutationen --- bis zur Auswertung über die xlsx-Ausgabe, deren
  abgeleitetes Kind die CSV-Datei ist, und die daraus erzeugten LaTeX-Tabellen und TikZ-Diagramme.
