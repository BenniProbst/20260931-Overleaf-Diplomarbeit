...
\begin{itemize}
  ...
  (Kompositions-Slots T0--T17) tragen die Binary-Permutation eines in der Forschung verwendeten oder allgemein bekannten Teil-Entwurfs-Algorithmus, drei System-Haupt-Achsen ---
  Ziel-ISA, Betriebssystem und Erweiterungs-Hardware --- beschreiben die Bau- und Ziel-Plattform,
  und ein eigenständiger Mess-Achsen-Realm hält die Mess-Belange von beidem getrennt; eine optionale neunzehnte Achse existiert nur, wenn man IO auf eine Festplatte aktiviert und in den Algorithmus-Entwurf mit einbindet.
  ...
  eigenständigem Suchentwurf abdecken. Der XML-Entwurf bildet mithilfe der Cache-Engine die einzelnen Algorithmus-Bestandteile zur Kompilierzeit echt ab und ist damit eine Compiler-Compiler-Bauanleitung in einem model-driven Optimierungs-Stack.
  ...
  Cache-Engine-Standard laufen (Abschnitt~\ref{sec:prtart-demo}). Der Einsatz eines Prüflings beweist die vollständige Erweiterbarkeit des Systems zur effizienten Weiterentwicklung neuartiger Ansätze im Umgang mit cache-aware Algorithmen und beschleunigter Suche.
