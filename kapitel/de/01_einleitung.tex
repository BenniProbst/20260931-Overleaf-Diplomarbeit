...
Im Zentrum dieser Arbeit stehen trie-basierte Indizes und cache-line-optimierte Verarbeitung. Seit dem
...
\begin{description}
  ...
  ordnen sie sich bestehenden Algorithmus-Kategorien zu, begründen sie neue oder einen Mix; auf
  welcher konzeptionellen Ebene sollte dieser Schnitt verlaufen? Zentral ist dabei: Was ist
  überhaupt eine Erweiterung des Systems, und wie wirkt sich das Hinzufügen oder Wegschneiden
  einzelner Erweiterungs-Bausteine --- etwa der aus einer einzelnen Veröffentlichung stammenden
  Entwurfsbestandteile --- auf das Cache-Line-Awareness-Potential des Gesamtsystems aus? Braucht es
...
Autors übernommen (zur Herkunft siehe Abschnitt~\ref{sec:anatomy-model}), der Beitrag dieser Arbeit ist
...
\begin{itemize}
  ...
  umgesetzt mit Boost.MP11-Compile-Time-Typlisten-Bausteinen
...
daraus die Konzepte eines cache-aware Mess-Systems: die Problemstellung und ihre Anforderungen, den
