...
Unter den digitalen Strukturen indiziert ein \emph{Trie} (Präfix-/Radix-Baum) Schlüssel anhand
ihrer Byte-Folge statt durch Vergleich, sodass die Länge des Suchpfads von der Schlüssellänge
abhängt und nicht von der Anzahl gespeicherter Schlüssel; \emph{Radix-} und \emph{PATRICIA}-Bäume
kollabieren dünn belegte Ein-Kind-Ketten durch Pfadkompression.
% [Beleg-TODO 2.2.1] Trie-Primaerquellen de la Briandais 1959 / Fredkin 1960 / Morrison 1968 via SLUB nachtragen
\emph{Verzweigungsgrad} (Fanout) und \emph{Knotenrepräsentation} bestimmen Platzbedarf wie
Cache-Verhalten, weshalb der \emph{Adaptive Radix Tree} (ART)~\cite{leis2013art} die
Knotenrepräsentation an den tatsächlichen Fanout anpasst; ART dient dieser Arbeit durchgängig als
Referenzentwurf. Die konkreten internen Ausprägungen dieser Klassen --- etwa ARTs Knotentypen ---
werden als \emph{Instanzen} erst im Stand der Technik (Kapitel~\ref{ch:sota}) seziert.
