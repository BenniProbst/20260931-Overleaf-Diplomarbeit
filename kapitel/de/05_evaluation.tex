...
Intel-Gracemont-Kernen (\texttt{odroid\_gracemont}). Der ZIH-Cluster (Sapphire Rapids)~\cite{zih_hpc_compendium_hardware}
...
Gültigkeitskriterium ist $t_1 \ge t_2 \ge t_3$ für die Wall-Clock-Zeiten der drei Varianten (mit
