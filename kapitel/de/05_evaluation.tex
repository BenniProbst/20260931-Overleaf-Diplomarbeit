...
besitzen eine gegen die vorverarbeiteten Dateien berechnete reale Akte, \texttt{dna} die Akte der
...
Extern & Messmaschinen decken die Zielplattformen nicht ab & registrierte Signaturen prod1, prod2, ODROID\@; ZIH als IS3 deklariert & ZIH und HBM\@: deklariert, nicht vermessen (n/a) \\
...
Schluss & Perzentile erfunden, Mittelwerte verzerrt & Nearest-Rank ohne Interpolation; geometrische Aggregation & implementiert (Auswertungs-Baum); Kopien in den Werkzeugen: ausgewiesene Lücke \\
...
deklariert und nicht vermessen (n/a) oder nicht implementiert. Keine Zeile nennt eine Zahl ohne
