...
\begin{tikzpicture}[font=\footnotesize,>=Stealth,
  ...
  \node[og] (cs) at (9.3,-2.6){\textbf{CSV-Baum}\\Ordner je Blatt; WIDE 189 Spalten, Pipeline-Sicht 16 + 16};
...
\begin{tikzpicture}[font=\footnotesize,>=Stealth,thick,
  ...
  \node[lg] (mp)   at (8.2,-2.6){\textbf{Mappe (xlsx)}\\CSV-Baum (Ordner je Blatt); Anhang-Generatoren};
