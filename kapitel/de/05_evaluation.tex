...
\begin{tikzpicture}[font=\footnotesize,>=Stealth,
  ...
  \node[og] (xl) at (12.4,-2.6){\textbf{Mappe (xlsx)}\\Stamm: entsteht immer; ein Blatt je Unter-Achsen-Permutation};
...
drei Mess-Ebenen und die Zähler mit einem Mess-Thread. Untere Reihe: Die Mappe ist der Stamm, die CSV ihr
Kind, die Generatoren rendern je Sprache in das \texttt{tabellen}-Verzeichnis, das Manuskript bindet die
...
Verdrahtung des Kern-Pinnings in das Lauf-Profil ist als Bau-Schritt benannt
...
Writer und Projektion sind gebaut; die Persistenz-Prüfung liest die CSV-Ausgabe, die Prüfung an der
...
über 43 Permutationen --- echte DLL-Messung; 27 kartesische Kombinationen aus SIMD, Layout und
Allokator plus 16 weitere über vier Achsen --- dokumentiert Anhang~\ref{app:measurements} samt ihren
Limitierungen (Abschnitt~\ref{sec:measurements:limitations}); sie variiert sieben Organ-Achsen, die
Kampagne variiert alle achtzehn. Die vollständigen Läufe der Pflicht-Messreihen A--C auf den
...
liegen für die Smoke-Reihe vor (43 Permutationen, sieben Achsen, Anhang~\ref{app:measurements}), für die
