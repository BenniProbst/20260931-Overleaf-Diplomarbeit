...
\begin{tikzpicture}[font=\scriptsize,>=Stealth,align=center,
  ...
  \node[fl] at (7.5,-5.25){1 Genus-Interface\\2 Stempel\\3 Mess-Durchstich \texttt{IMessVisitor}};
  \node[fl] at (5.0,-5.25){1 geerbtes Ziel-Genus\\2 Stempel $+$ angeschlossene\\3 Mess-Durchstich};
