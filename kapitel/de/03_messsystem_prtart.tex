...
\emph{Visitor} ist die Mess-Naht am \texttt{dlopen}-Übergang, \emph{Chain of Responsibility} trägt die
...
\emph{Composite} im Sinne des Katalogs hat keinen Anker im Code. Nicht verwendet werden im Hot-Path
...
\enquote{Bridge} tritt im Code nur als Tätigkeitswort auf, nicht als Muster. Das \emph{Command}-Muster
trägt mehrere Rollen --- die übersetzungszeitliche Command-Basis der Achsen, die System-Komplex-Achse
...
als Null.
%% OWNER-VORLAGE: OV-02 --- Kern-Modi der hybriden Messung (Owner G-091): Sechs-Modus-Modell mit HybridAware
%% als Pflicht-Modus im Präsens, Durchführungs-Stand (Verdrahtung in das Lauf-Profil offen) an genau
%% dieser einen Stelle in Kapitel 3; Default gesetzt, Widerspruch genügt.
...
ist deshalb Pflicht-Bestandteil des Mess-Modells, keine Option. Durchführungs-Stand: Der
Pinning-Aktuator ist gebaut, die Verdrahtung der Kern-Modi in das Lauf-Profil --- für prod2, den Intel
