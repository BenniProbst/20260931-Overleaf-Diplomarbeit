...
vereinen; im Code wie im Plan gelten die Benchmark-Systeme dabei als Unter-Achse des Messsystems (der
Laufzeit-Parameter \texttt{workload} des Last-Rahmenwerks), weil sie laufzeitspezifische Änderungen der
Kette von der XML zur Tier-Binary (Abschnitt~\ref{sec:mess-chain}) verwalten: Lastprofile und Datensätze
wechseln, ohne dass die Tier-Binary neu übersetzt wird.
\end{nurlang}
\begin{nurkurz}
Auch die \emph{Lasten} erscheinen als Instanzen. Die in der Literatur verwendeten Workloads entstammen
