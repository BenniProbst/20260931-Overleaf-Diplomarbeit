...
\begin{tikzpicture}[font=\footnotesize,>=Stealth,align=center]
  ...
  \node[font=\scriptsize,text width=12.2cm,align=center] at (0,-6.22){\texttt{std::variant} ist für Organ-Achsen verboten (Laufzeit-Overhead, Binary-Bloat); der Live-Weg sind monomorphe CRTP-Concept-Achsen, \texttt{baustein\_variants} ist ein quarantänierter Test-Bestand mit statischer Prüfung};
...
kollidieren. Der Planer führt einen SHA-256 über seine Version, die Ziel-ISA und das Betriebssystem;
...
Auswerte-Glieder nicht implementiert, nächster Absatz); viertens das Live-Ranking der hot geladenen Tier-Binaries im
