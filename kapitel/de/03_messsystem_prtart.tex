...
sind implementiert; die Hüllen \texttt{std::map} und \texttt{std::vector} sind vollständig aufzuführen (vorgesehen),
und die Genus-Iterator-Bibliothek für die ordnungsbasierten Operationen ist nicht implementiert.
\end{nurkurz}
