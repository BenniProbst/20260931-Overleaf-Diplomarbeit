...
(Abbildung~\ref{fig:modi-kette}). Einen Debug-Arbeitsmodus gibt es nicht; die Bau-Varianten Debug, Messung und Release gelten fort, und die Debug-Variante wird weiter ausgebaut: \texttt{--debug} ist ein Schalter
der Planer-Shell für den Verdrahtungs-Check --- ein Flag, kein Arbeitsmodus; unter \texttt{--debug} fährt
das Konformitäts-Gate zusätzlich den Genus-Testsatz (wie geplant: Tests nur mit den Debug-Binaries,
...
nach; auf der Hybrid-Ebene wiederholt sich dieselbe Kette (Abbildung~\ref{fig:modi-kette}). Einen Debug-Arbeitsmodus gibt es nicht; die Bau-Varianten Debug, Messung und Release gelten fort, und die Debug-Variante wird weiter ausgebaut: \texttt{--debug} ist ein Flag
der Planer-Shell, kein Arbeitsmodus; unter
\texttt{--debug} fährt das Konformitäts-Gate zusätzlich den Genus-Testsatz, und dieser indirekte
...
Flag der Planer-Shell und kein Modus ist (unter \texttt{--debug} fährt das Konformitäts-Gate zusätzlich
den Genus-Testsatz; dieser indirekte Debug-Modus fällt mit dem Release-Bau zusammen). Keine dieser
