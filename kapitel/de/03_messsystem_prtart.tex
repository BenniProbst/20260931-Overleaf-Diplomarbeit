...
Neunzehn-Achsen-Zählung (T0--T18, Zwischenstand Juli 2026) führte Telemetrie und ISA noch als
Kompositions-Achsen; beide sind in die System-Sphäre umgezogen, und das Persistenz-Ziel ist als
achtzehnte Organ-Achse hinzugekommen. Viele Achsen sind in Sub-Achsen verfeinert (etwa SA1--SA4
...
erneut stattfindet und ihre Vertrauensstufe mitführt. Im Implementierungsstand dieser Arbeit liegt
von dieser Achse das Provenienz-Vokabular samt SPD-Parser und Fehler-Domäne vor; Erhebungs-Kette
und Plattform-Auswahl-Matrix sind Entwurf (Kapitel~\ref{ch:impl}).
...
Zeile schließlich hält bei Prüflings-Mischbauten die Merge-Strategie samt Prüfling fest, sodass die
Hybrid- und Full-Join-Stände der Drei-Stufen-Prüfung (Abschnitt~\ref{sec:mess-chain}) am Stempel
unterscheidbar bleiben; bei reinen Cache-Engine-Bauten bleibt sie leer. Gemessene \emph{Werte} ---
...
Sieben-Phasen-Pipeline (Abschnitt~\ref{sec:impl-pipeline}) über seinen \texttt{ExperimentDriver}
ausführt; die Planer-Rolle der Kette und die Builder-Rolle teilen sich implementierungsseitig heute
eine Binary in zwei Rollen, Kapitel~\ref{ch:impl}), die \texttt{CacheEngine} (die Achsen-Bausteine-Bibliothek mit den
