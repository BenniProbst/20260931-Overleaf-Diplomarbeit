...
Concurrency-Pattern und Telemetry bei --- den 4+1+2-Pool-Allokator in der Free-List-Sub-Achse,
...
\begin{tikzpicture}[font=\footnotesize,align=center,
  ...
  \node[font=\scriptsize,align=center] at (0,-1.65){\textcolor{orange}{\textbf{orange}} $=$ PRT-ART-eigener Beitrag (inkl.\ Build-Achse Page-Type) \quad \textcolor{green!50!black}{\textbf{grün}} $=$ Cache-Engine-Standard (Compile-Time-Fallback)};
\end{tikzpicture}
\caption{PRT-ART als Demonstrator im M-Modell: Der Prüfling steuert sechs eigene Schlüsselstellen bei --- die Build-Achse Page-Type sowie die fünf Achsen-Organe Layout, 4+1+2-Allokator, Prefetch, OLC-Nebenläufigkeit und Telemetrie --- und bezieht die übrigen vierzehn Kompositions-Achsen über den Compile-Time-Fallback aus der Cache-Engine; so entsteht ein vollständiges, mess-fähiges Lebewesen aus wenigen eigenen plus vielen Standard-Organen.}\label{fig:prtart-demo}
\end{figure}
