...
\end{tikzpicture}
\caption{Das Drei-Ebenen-Modell: Gattung (Ebene 1, Außen-Interface) $\to$ Tier-Unterklasse (Ebene 2, fester Achsen-Satz) $\to$ Organe/Achsen (Ebene 3). Die SearchAlgorithm-Gattung trägt das \enquote{Säugetier} mit den achtzehn Organ-Achsen; die Container-Gattung die Unterklassen Set/Sequence/Adapter/View.}\label{fig:three-levels}
\end{figure}
...
Auch die Ablauf-Methodik eines Laufs (Debug-, Mess- oder Release-Durchführung) bleibt Unter-Achse
