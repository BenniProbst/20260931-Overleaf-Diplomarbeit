...
Algorithmus- und Cache-Sicht: T1 trägt im Code die drei Traversal-Bausteine
...
%% OWNER-VORLAGE: OV-02 --- T8 Sperr-Modus-Satz: die Vierteilung read-only/read-write/upgradeable/optimistische
%% Validierung ist im Code nur der deprecierte, konsumentenlose Entwurf locking_mode.hpp (Lens-r16 M-1); gebaut
%% sind CC1/CC2. Default: Entwurf benannt und von den Bausteinen getrennt; Alternative: Satz entfällt.
%% Widerspruch genügt.
...
Achsen-Entwurf (\texttt{locking\_\allowbreak{}mode.hpp}) und kein Baustein: gebaut sind die Muster als
...
die Durchreich-Variante (\texttt{None}), der Knotentyp (T4) trägt im Code keine None-Variante und wird
