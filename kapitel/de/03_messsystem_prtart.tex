...
\begin{figure}[htbp]\centering
% Kein \resizebox: die Zeichnung ist ~15.1cm breit und passt nativ in \textwidth (16cm); die Ebenen 3-5
...
\begin{tikzpicture}[font=\footnotesize,>=Stealth,align=center,
  ...
  % Container-Ast als Kamm: Stamm links neben den Genus-Kaesten, je Genus ein Zahn auf den West-Anker
