...
Gattung Map und ihrem Gattung \texttt{SearchAlgorithm} (Abschnitt~\ref{sec:anatomy-levels}). Zweitens
...
übersetzt, gehört zur Gattung Map und ihrem Gattung \texttt{SearchAlgorithm} (Abschnitt~\ref{sec:anatomy-levels}).
