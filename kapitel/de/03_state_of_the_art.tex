...
% [AP-S1] ===== Ab hier ROHMATERIAL fuer 3.4 (Workloads) / 3.5 (Messen) =====
% Profil-Schema + SOTA-Workload-Tabelle bleiben erhalten und werden in 3.4 reorganisiert; die HW/Scheduling-
% Tabelle (tab:hw-sched) + Allokator-Tabelle (tab:allocator-profiles) werden aus 3.3 referenziert und spaeter
% physisch in 3.3 verschoben. Die Forschungsluecke wird zu 3.7.
