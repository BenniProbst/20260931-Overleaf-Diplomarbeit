...
% [AP-S1] 3.4 ausformuliert. Verbleibendes ROHMATERIAL: nur noch die HW/Scheduling-Sektion (Tabelle von 3.3.3
% referenziert, Prosa teils dort dupliziert -> spaeter nach 3.3.3 mergen). Die Forschungsluecke wird zu 3.7.
...
\texttt{cache\_engine/}\allowbreak\texttt{algorithm\_profiles/} Metadaten fest, die Achsen-Belegung (page, node,
