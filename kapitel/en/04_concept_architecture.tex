...
own implementations in the page, layout, allocator, prefetch, concurrency-pattern, and measurement
axes (4+2 pool allocator in the free-list sub-axis, path-oriented (bundle) prefetch, OLC with reserved value blocks, and the
