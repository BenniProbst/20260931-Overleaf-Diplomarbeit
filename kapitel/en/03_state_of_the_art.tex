...
(\texttt{axis\_<nn>\_<name>/}). Table~\ref{tab:axes-overview} gives
...
The terms introduced in Section~\ref{sec:workloads-basics} (Fundamentals) --- load, workload, workload
framework, and the \emph{goal of variation} --- receive their scientific instances here.
