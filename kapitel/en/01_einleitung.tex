...
\begin{itemize}
  ...
  organs --- the build axis page type and five composition axes ---, while value placement and
  serialization currently run via the cache-engine default in the measurement path
  (Section~\ref{sec:prtart-demo}).
  ...
  provides the required ranking, while the automatic selection and binary shipping are envisioned as
  an extension.
\end{itemize}
