...
\emph{realms} --- organ, system, measurement --- with one class root each, one offer catalogue each
...
\texttt{std::map} core contract as a host-side composition layer over the point-lookup primitive
...
compiled in by default (opt-in), and not part of the contract. On RQ3.a: point page --- the
direct-index pages Array$_{256}$ and Array$_{65535}$ --- versus compact page --- the vector pages
