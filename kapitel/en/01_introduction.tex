...
(Comdare\,/\,BEP~Venture~UG, originally (2021) for optimizing deduplication procedures in the
UltiHash database --- specifically graph optimization in hash-based lookup directories); the
contribution of this thesis is its transfer to cache-aware search structures and its
