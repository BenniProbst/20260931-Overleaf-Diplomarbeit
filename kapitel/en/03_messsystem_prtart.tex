...
binary, and the hybrid tier binary. The planner resolves the user XML against the three offering catalogues
and chooses the measurement axes at its runtime; the CEB contains this measurement choice compiled in,
