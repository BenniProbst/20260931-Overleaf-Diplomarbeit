...
and is never read flat as \texttt{cpe}; the bracket depth of an entry is its meta-meta level, the flag
\texttt{e} denotes an efficiency-core algorithm. A fourth realm line for the mixing strategy of a
