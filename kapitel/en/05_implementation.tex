...
(\texttt{generate\_\allowbreak module\_\allowbreak from\_\allowbreak profile}). Every permutation is identified by a
bit-packed \emph{permutation flag} structure. With the N-phase refinement of the matrix,
the flag system grows from 9 banks ($\sim$50 bit) to a wider, multi-bank bit-packed
