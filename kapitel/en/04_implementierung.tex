...
under \texttt{--debug} the conformance gate additionally runs the genus test set, and this indirect debug
...
the genus test set, an indirect debug mode that coincides with the release build.
\end{nurkurz}
