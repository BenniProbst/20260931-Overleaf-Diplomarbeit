...
\begin{tikzpicture}[font=\footnotesize,>=Stealth,
  ...
  \node[font=\tiny,anchor=south] at ([xshift=3.95cm,yshift=1pt]bp){standard route without hybrid: CEB probe dock $\to$ tier binary directly; with hybrid: probe dock $\to$ mux $\to$ dock slot $\to$ tier binary};
