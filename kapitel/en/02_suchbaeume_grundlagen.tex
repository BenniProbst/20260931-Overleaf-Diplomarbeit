...
whole appears as a probe and not as a structure measured alongside throughout.
...
on two of them as contract shells: on the ordered map as the common denominator of comparison- and
...
contract shell of its own in this thesis --- its building blocks, where present, are subordinate to the
ordered map shell and merely switchable (preceding paragraph). The placement of both shells in the
