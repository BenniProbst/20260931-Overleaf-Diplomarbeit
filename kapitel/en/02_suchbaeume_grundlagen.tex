...
design decision made? A \emph{static} design fixes it before the first query arrives --- be it
...
B\textsuperscript{+} nodes on exactly this basis: if all lines of a multi-line node are announced
