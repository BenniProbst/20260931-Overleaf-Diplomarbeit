...
Using the per-permutation records, this section quantifies, at the micro granularity, which
axis contributes most to the performance variance; macro- and whole-system benchmarking add
the operation and YCSB-load-profile levels. The ranking across the three granularities yields
the recommendation of default configurations per workload class.
