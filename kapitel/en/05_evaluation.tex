...
\texttt{--debug} the conformance gate additionally runs the genus test set; this indirect debug mode
...
family contract (under \texttt{--debug} extended by the genus test set) before the post-compile
...
runs the genus test set; this indirect debug mode coincides with the release build). A binary found in
