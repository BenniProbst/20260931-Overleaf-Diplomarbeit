...
reference catalogue is built ($2^{17} = 131072$ binary identities, Section~\ref{sec:mess-chain}); the
cardinality of the real permutation space the planner computes dynamically (subcommand \texttt{simulate}).
