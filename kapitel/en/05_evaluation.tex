...
regime ordinal) per axis assignment and genus-interface call (channel address axis $\to$ genus $\to$
...
measurement thread, the threading of the family itself is left to the tier binary, and \texttt{--debug} is
...
conformity check at the probe dock (Section~\ref{sec:impl-contracts}), and build as well as measurement runs
