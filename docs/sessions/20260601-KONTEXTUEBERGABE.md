...
> + Bug-Tabelle), `docs/sessions/20260601-bilingualer-compile-schalter.md` (Schalter-Konzept),
> `docs/sessions/20260601-gesamtstand-und-aequivalenz.md` (Äquivalenz-Prinzip).
