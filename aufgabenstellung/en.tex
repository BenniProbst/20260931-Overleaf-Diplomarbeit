...
systems. The Chair of Databases at TU Dresden addresses the hardware-conscious optimisation of such
...
radix trees to specialised, custom-built constructs --- span a large yet conceptually uniform
...
of the art comprises numerous mature methods, yet each optimises only
...
The separability of the individual algorithm components demanded here is realized in this thesis
--- building on the foundations of Chapter~\ref{ch:foundations} --- by the axis framework and the
three-granularity measurement methodology (Chapter~\ref{ch:measurement}).
...
\begin{enumerate}
  ...
  design components into design levels of a generalised algorithm categorisation.
  ...
  measured --- within the search-algorithm shell as well as the algorithm-category shell --- in each
...
standard interfaces of the well-known std::map and std::vector container shells, p50/p95/p99
