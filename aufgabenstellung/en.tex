...
\begin{enumerate}
  ...
  \item Extend the chain into a consistently declaratively driven overall process: the chain starts
  ...
  with latency-minded best practices in database research), \emph{macro-benchmarking} (the
