...
\begin{description}
  ...
  ranking, the Pareto front, and the selection filter chain a candidate is a measured permutation
  under selection, and the comparison candidates of the workload variation are the compared methods.
