...
\begin{description}
  ...
  sub-interfaces); this indirect debug mode coincides with the release build and is not kept as a
  ...
  reported target family. The family tests of the conformance gate are generic for all genera of the
  ...
  subspecies, the implementation of the family interface with possibly extended sub-interfaces (in
  ...
  composition of its organs. The genus tests of the conformance gate check only the special
  interfaces. As-is: today the code carries the genus only as an axis assignment; the genus
  ...
  measurement (under \texttt{--debug} additionally the genus test set; Appendix~\ref{app:interfaces}).
