...
\begin{description}
  ...
  \item[Hybrid tier binary] The fourth carrier stage in the build order, in the processing chain the
  optional mux insertion between the CEB probe dock and the tier binary: a module of the family
  HeuristikAdapter
