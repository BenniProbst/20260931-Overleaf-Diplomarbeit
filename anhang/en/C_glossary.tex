...
\begin{description}
  ...
  defines measurability; per family a probe dock materializes it. The concept core is the intersection
  of the interfaces of its families (the same intersection rule as between family and genus). The concept
  is not maintained as a
