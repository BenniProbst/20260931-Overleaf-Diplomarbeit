...
\section{System sphere: telemetry and measurement instrumentation}

In the nineteen-axis numbering this quantity was the \emph{telemetry organ} (then T10); since the axis reordering it has moved, two-way split, into the system sphere --- measurement-tooling sub-axis \emph{and} build quantity (cf.\ Section~\ref{sec:axis-triad}). Its building-block catalogue is retained here.
