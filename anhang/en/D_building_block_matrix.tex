...
\section[System sphere: complex bracket and build toolchain]{System sphere: outer complex bracket (\texttt{build\_target\_complex}) and build toolchain (\texttt{build\_toolchain})}
...
\section[Measurement sphere: load framework --- meta-meta axis]{Measurement sphere: load framework (\texttt{load\_framework}) --- meta-meta axis}
