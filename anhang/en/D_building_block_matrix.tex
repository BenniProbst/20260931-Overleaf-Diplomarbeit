...
\emph{Honesty note:} the repetition count of a run and the three measurement modes (debug, measurement and release execution) are deliberately \emph{not} in this list. The repetition count is currently a pure label dimension without a compile-time anchor, and the three modes do not yet exist as types; both become reflectable only once they are typed. A hand-written entry would be a phantom --- the honest-0 doctrine forbids it (open item W2-B).
