...
\begin{description}
  ...
  exist (\texttt{--debug} is a flag of the planner shell; under \texttt{--debug} the conformance gate
  additionally runs the genus test set, an indirect debug mode that coincides with the release build),
