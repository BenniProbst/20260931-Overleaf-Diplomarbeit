...
\begin{axis}[
    ...
    scale only axis,
    title={3D raw-data view: overall latency (ns/op) (search algorithm x workload)},
    xlabel={workload},
...
\caption{3D raw-data view: overall latency (ns/op) (search algorithm x workload)}
\end{figure}
