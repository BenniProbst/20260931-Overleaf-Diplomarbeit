...
\begin{axis}[
    ...
    scale only axis,
    title={3D raw-data view: lookup latency p50 (ns/op) (search algorithm x workload)},
    xlabel={workload},
    ...
    colorbar,
    colormap/viridis,
    zlabel={lookup latency p50 (ns/op)},
    xtick={0,1,...,0},
    ytick={0,1,...,0},
    xticklabels={ycsb\_c},
...
\caption{3D raw-data view: lookup latency p50 (ns/op) (search algorithm x workload)}
\end{figure}
