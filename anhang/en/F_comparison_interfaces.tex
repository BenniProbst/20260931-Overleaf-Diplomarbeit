...
(Section~\ref{sec:measurement-system}), it becomes explanation-worthy, per standard function, what
...
(Section~\ref{sec:impl-architecture}); the shared functions (iteration,
...
\emph{Conformance subset.} The conformance gate (Section~\ref{sec:measurement-system}) checks a
...
measurement act (Section~\ref{sec:measurement-system}). The conformance gate checks the core subset
