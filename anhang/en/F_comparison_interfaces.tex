...
This appendix presents --- complementing Section~\ref{sec:compare-interfaces} --- the complete
...
(Section~\ref{ssec:dynamics-levels}), it becomes explanation-worthy, per standard function, what
...
\emph{Conformance subset.} The conformance gate (Section~\ref{ssec:measurement-patterns}) checks a
...
that the conformance gate (Section~\ref{ssec:measurement-patterns}) checks before each measurement,
...
(Table~\ref{tab:if-decomp}). For this thesis that is the central observation: all map accessors and
...
measurement act (Section~\ref{sec:stdmap-interface}). The conformance gate checks the core subset
