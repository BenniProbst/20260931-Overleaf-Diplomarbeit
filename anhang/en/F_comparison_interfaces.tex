...
hulls are implemented as separate family adapters: the Map family via the functional drive of the
...
\texttt{tier\_clear}; an adapter cutting across the family is ruled out by the type system. The case
...
against an oracle of the standard library --- \texttt{std::map} for the Map family,
...
insert drive of the Map family carries the semantics of \texttt{insert\_or\_assign} --- insert or
