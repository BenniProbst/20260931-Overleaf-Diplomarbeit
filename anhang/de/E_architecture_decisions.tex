...
\begin{description}
  ...
  das Persistenz-Ziel, auf ihren In-Memory-Vertreter festgelegt ---, und der rohe
  ...
  Organ-Zähler von achtzehn mit Prüfung auf ABI-Bruch), sodass keine Komposition dieses Genus mit offener
  Achse übersetzt.
  ...
  \textbf{Umsetzungsstand:} Der Ausbau des Gatters auf die volle \texttt{std::map}-Schnittstelle und die
  Genus-Iterator-Bibliothek sind nicht implementiert; die Forderung, die Container-Genera über eine
  ...
  Katalogkopf rund 224~GB und 24~h vollständiger Bau) ist nur mit Wiederverwendung gebauter Binaries und
  ...
  enthält bewusst keine Vorgabewerte --- ein generiertes Makefile wäre eine zweite Wahrheit ohne
  Gegenwert.
