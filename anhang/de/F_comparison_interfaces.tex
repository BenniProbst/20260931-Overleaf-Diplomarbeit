...
gekennzeichnet. Die Spalte \enquote{seit} nennt die einführende Standard-Fassung. Die exakten
...
und eine werfende Hülle als nicht-konform gilt: \texttt{operator[]} ist dort ein nicht-mutierendes
\texttt{std::optional}-Lesen (der Schreibpfad läuft über \texttt{set()}/\texttt{insert\_or\_assign}),
und \texttt{at} wirft nicht (\texttt{optional}-/Status-Rückgabe). Für diese Arbeit ist das die zentrale
Beobachtung: Sämtliche
