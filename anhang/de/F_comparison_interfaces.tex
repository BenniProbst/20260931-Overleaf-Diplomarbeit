...
Vertrags-Hüllen sind als getrennte Gattungs-Adapter implementiert: das Map-Konzept über den funktionalen
...
Standardbibliothek --- \texttt{std::map} für das Map-Konzept, \texttt{std::deque} für die
...
Einfüge-Antrieb des Map-Konzepts trägt die Semantik von \texttt{insert\_or\_assign} --- Einfügen oder
