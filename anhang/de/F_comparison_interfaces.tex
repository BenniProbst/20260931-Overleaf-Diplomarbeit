...
% [AP-G5-Anhang] Vollstaendige Standard-Interface-Tabellen (C++23) zu Abschnitt~\ref{sec:software-means}.
...
Dieser Anhang führt --- ergänzend zu Abschnitt~\ref{sec:software-means} --- die vollständige
...
Achsen-Algorithmen ersetzt (Abschnitt~\ref{sec:software-means}), wird je Standard-Funktion
...
(Abschnitt~\ref{sec:software-means}); die geteilten Funktionen (Iteration,
...
\emph{Konformitäts-Teilmenge.} Das Konformitäts-Gatter (Abschnitt~\ref{sec:software-means})
...
Kern-Operationen, die das Konformitäts-Gatter (Abschnitt~\ref{sec:software-means}) vor jeder
...
(Abschnitt~\ref{sec:software-means}). Das Konformitäts-Gatter prüft die in
