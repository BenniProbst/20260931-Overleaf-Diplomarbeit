...
% [AP-G5-Anhang] Vollstaendige Standard-Interface-Tabellen (C++23) zu Abschnitt~\ref{sec:measurement-system}.
...
Achsen-Algorithmen ersetzt (Abschnitt~\ref{sec:measurement-system}), wird je Standard-Funktion
...
(Abschnitt~\ref{sec:impl-architecture}); die geteilten Funktionen (Iteration,
...
(Abschnitt~\ref{sec:measurement-system}). Das Konformitäts-Gatter prüft die in
