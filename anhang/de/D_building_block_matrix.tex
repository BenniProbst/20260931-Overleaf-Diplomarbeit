...
(Kapitel~\ref{ch:sota}) verweist. Je Achse sind der Zweck, die \emph{statischen} Sub-Achsen
...
\texttt{Exgen\allowbreak{}Allocator} (A18) & Single-Threaded Specialized Allocator mit Optimierungen für Single-Threaded Workloads. UT Austin (IEEE CAL 2025, ar\allowbreak{}Xiv:2510.10219). „Old is Gold`` Prinzip. & P— (Research, Konfidenz medium) \\
...
\midrule
\endhead
\texttt{Raw\allowbreak{}Binary\allowbreak{}Serialization} & Roh-Byte-Speicherlayout (memcpy). Baseline ohne Transformation. Minimaler CPU-Aufwand. Typ. für In-Memory-Workloads ohne Kompression. Variante: \texttt{serieialisierte\_\allowbreak{}scan()} liest 32-Bit Felder + Order-sensitive Checksum. & Code/\allowbreak{}Baseline \\
...
\texttt{Watermark\allowbreak{}Flush} & Schwellwert-gesteuerte Flush-Policy (Default 75\% Kapazität). Iterable Aspekt mit 5 Varianten (50\%, 65\%, 75\%, 85\%, 95\%) für Laufzeit-Permutation. Verwandt mit LSM-Tree Memtable-Trigger (O'Neill 1996). & LSM-Tree O'Neill 1996 (verwandt) /\allowbreak{} Code Implementation \\
