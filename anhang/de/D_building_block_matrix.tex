...
\emph{Bau-Versionskennung:} \texttt{opt\_\allowbreak{}level}, \texttt{simd} und \texttt{atomic128} materialisieren als Flags der Übersetzungs-Naht und erscheinen damit im Bau-Versions-Suffix der Binary --- einer geordneten Acht-Segment-Folge, in der ein leeres Glied schlicht kein Segment erzeugt (vgl.\ Abschnitt~\ref{sec:stamp-model}). In der \texttt{binary\_\allowbreak{}id} stehen sie niemals.
