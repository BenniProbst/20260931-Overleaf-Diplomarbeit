...
\section{System-Sphäre: Äußere Komplex-Klammer (\texttt{build\_target\_complex}) und Bau-Werkzeugkette (\texttt{build\_toolchain})}
...
\section{Mess-Sphäre: Last-Rahmenwerk (\texttt{load\_framework}) --- Meta-Meta-Achse}
...
(\texttt{Code/08\_appendix\_generator}) leitet sie aus den drei generierten Achsen-Registries des
