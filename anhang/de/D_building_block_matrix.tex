...
\emph{Ehrlichkeits-Notiz:} Die Wiederholungszahl eines Laufs und die drei Mess-Modi (Debug-, Mess- und Release-Durchführung) sind bewusst \emph{nicht} in dieser Liste. Die Wiederholungszahl ist heute eine reine Etikett-Dimension ohne übersetzungszeitlichen Anker, die drei Modi existieren noch nicht als Typen; beide werden erst nach ihrer Typisierung reflektierbar. Ein handgeschriebener Eintrag wäre ein Phantom --- die honest-0-Doktrin verbietet ihn (offener Punkt W2-B).
