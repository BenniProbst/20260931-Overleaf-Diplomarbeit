...
\section{System-Sphäre: Telemetrie und Messinstrumentierung}

Diese Größe war in der Neunzehner-Zählung das \emph{Telemetrie-Organ} (damals T10); seit der Achsen-Neuordnung ist sie zweigeteilt in die System-Sphäre umgezogen --- Mess-Tooling-Unter-Achse \emph{und} Bau-Größe (vgl.\ Abschnitt~\ref{sec:axis-triad}). Ihre Baustein-Katalogisierung bleibt hier erhalten.
