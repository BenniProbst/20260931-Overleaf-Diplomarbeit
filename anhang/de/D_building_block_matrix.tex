...
Diese Achse ist das \emph{Such-Organ} (T0) des Lebewesens \texttt{SearchAlgorithm} (vgl.\ Kapitel~\ref{sec:sota-instances}).
...
Diese Achse ist das \emph{Cache-Traversierungs-Organ} (T1) des Lebewesens \texttt{SearchAlgorithm} (vgl.\ Kapitel~\ref{sec:sota-instances}).
...
Diese Achse ist das \emph{Mapping-Organ} (T2) des Lebewesens \texttt{SearchAlgorithm} (vgl.\ Kapitel~\ref{sec:sota-instances}).
...
Diese Achse ist das \emph{Pfadkompressions-Organ} (T3) des Lebewesens \texttt{SearchAlgorithm} (vgl.\ Kapitel~\ref{sec:sota-instances}).
...
Diese Achse ist das \emph{Knotentyp-Organ} (T4) des Lebewesens \texttt{SearchAlgorithm} (vgl.\ Kapitel~\ref{sec:sota-instances}).
...
Diese Achse ist das \emph{Speicher-Layout-Organ} (T5) des Lebewesens \texttt{SearchAlgorithm} (vgl.\ Kapitel~\ref{sec:sota-instances}).
...
Diese Achse ist das \emph{Allokations-Organ} (T6) des Lebewesens \texttt{SearchAlgorithm} (vgl.\ Kapitel~\ref{sec:sota-instances}).
...
Diese Achse ist das \emph{Prefetch-Organ} (T7) des Lebewesens \texttt{SearchAlgorithm} (vgl.\ Kapitel~\ref{sec:sota-instances}).
...
Diese Achse ist das \emph{Nebenläufigkeits-Organ} (T8) des Lebewesens \texttt{SearchAlgorithm} (vgl.\ Kapitel~\ref{sec:sota-instances}).
...
Diese Achse ist das \emph{Serialisierungs-Organ} (T9) des Lebewesens \texttt{SearchAlgorithm} (vgl.\ Kapitel~\ref{sec:sota-instances}).
...
Diese Achse ist das \emph{Telemetrie-Organ} (T10) des Lebewesens \texttt{SearchAlgorithm} (vgl.\ Kapitel~\ref{sec:sota-instances}).
...
Diese Achse ist das \emph{Wert-Handle-Organ} (T11) des Lebewesens \texttt{SearchAlgorithm} (vgl.\ Kapitel~\ref{sec:sota-instances}).
...
Diese Achse ist das \emph{ISA-Organ} (T12) des Lebewesens \texttt{SearchAlgorithm} (vgl.\ Kapitel~\ref{sec:sota-instances}).
...
Diese Achse ist das \emph{Index-Organisations-Organ} (T13) des Lebewesens \texttt{SearchAlgorithm} (vgl.\ Kapitel~\ref{sec:sota-instances}).
...
Diese Achse ist das \emph{I/O-Dispatch-Organ} (T14) des Lebewesens \texttt{SearchAlgorithm} (vgl.\ Kapitel~\ref{sec:sota-instances}).
...
Diese Achse ist das \emph{Migrations-Organ} (T15) des Lebewesens \texttt{SearchAlgorithm} (vgl.\ Kapitel~\ref{sec:sota-instances}).
...
Diese Achse ist das \emph{Filter-Organ} (T16) des Lebewesens \texttt{SearchAlgorithm} (vgl.\ Kapitel~\ref{sec:sota-instances}).
...
Diese Achse ist das \emph{Pufferungs-Organ (Q1)} (T17) des Lebewesens \texttt{SearchAlgorithm} (vgl.\ Kapitel~\ref{sec:sota-instances}).
...
Diese Achse ist das \emph{Pufferungs-Organ (Q2)} (T18) des Lebewesens \texttt{SearchAlgorithm} (vgl.\ Kapitel~\ref{sec:sota-instances}).
