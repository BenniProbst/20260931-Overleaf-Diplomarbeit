...
\emph{Versions-Flag-Grammatik (A13, Owner-Entscheid E2 und Owner-Antwort Q3 vom 02.08.2026):} Die Version eines jeden Achsen-Algorithmus ist einheitlich dreistellig und beginnt mit \texttt{v}; Kurzformen sind verboten. Übersetzungszeitliche Wachen setzen die Form durch:
...
Das Hardware-Flag ist genau \emph{ein} Kleinbuchstabe, direkt an das Zahlen-Tripel angehängt; die Reihenfolge ist fest: erst das Hardware-Flag, dann optional das \texttt{e} für einen experimentellen Prüflings-Algorithmus. Ein \texttt{e} ohne Hardware-Flag ist ungültig. Weil diese Arbeit ausschließlich CPU-Code erzeugt, enden im Zielzustand alle Versionen auf \texttt{c} beziehungsweise \texttt{ce}.
