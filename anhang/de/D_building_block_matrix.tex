...
\texttt{Exgen\allowbreak{}Allocator} (A18) & Single-Threaded Specialized Allocator. UT Austin IEEE CAL 2025 (ar\allowbreak{}Xiv:2510.10219). 'Old is Gold'-Optimierungen für Einthread-Workloads, keine öffentliche Code-Referenz. & A18~\cite{li2025exgen} (UT Austin, IEEE CAL 2025, arxiv.org/\allowbreak{}abs/\allowbreak{}2510.10219) + Code/\allowbreak{}Baseline \\
...
\texttt{Vmem\allowbreak{}Magazines\allowbreak{}Allocator} (A23) & Vmem + Magazines (Slab-Erweiterung). Bonwick 2001 USENIX ATC. Per-CPU-Magazine für Skalierung, Kernel-Klassiker ohne öffentliche Code-Referenz. & A23~\cite{bonwick2001vmem} (Bonwick, USENIX ATC 2001, usenix.org/\allowbreak{}.../\allowbreak{}bonwick.html) + Code/\allowbreak{}Baseline \\
\bottomrule
\end{longtable}
\end{scriptsize}
