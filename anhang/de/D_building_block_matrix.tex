...
Die Achse macht das Ablage-Ziel der Struktur als eigenen Organ-Slot explizit, statt eine In-Memory-Annahme implizit mitzuführen. Im golden-Referenzkatalog ist sie auf ihren In-Memory-Vertreter festgelegt: siebzehn Achsen mit je zwei Ausprägungen und \texttt{persistence\_\allowbreak{}target} mit einer ergeben $2^{17} = 131072$ Referenz-Identitäten je System-Permutation (vereinfachende, überholte Annahme zweier Auslegungen je Achse; Regressions-Detektor, nicht Obergrenze); jede \texttt{binary\_\allowbreak{}id} führt gleichwohl das achtzehnte Segment \texttt{persistence\_\allowbreak{}target=\allowbreak{}persistence\_\allowbreak{}memory\_\allowbreak{}only}. Die Mächtigkeit einer vollständigen Messreihe ist davon verschieden: sie ist keine statische Zahl, sondern wird je Profil aus dem Director-Walk gezählt, als Obergrenze aus den je Achse im XML-Experiment gewählten Auslegungen, die erst zur Ausführung bekannt ist (Abschnitt~\ref{sec:mess-chain}).
