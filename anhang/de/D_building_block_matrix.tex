...
Diese Größe ist die zweite System-Haupt-Achse und damit Teil des \emph{Bluts} und keines Organs (vgl.\ Abschnitt~\ref{sec:axis-triad}); in der kanonischen, im Code geprüften Ordnung steht sie an Platz zwei von drei.
...
Diese Größe gehört zum dritten Realm --- den Mess-Achsen, dem \emph{Blut des Messens} (vgl.\ Abschnitt~\ref{sec:axis-triad}).
