% AUTO-GENERATED durch diagram_generator (E-2c, Pareto-/Tradeoff-Streuung p50 vs p99; lang=de)
...
\begin{axis}[
    ...
    scale only axis,
    title={Pareto-Streuung: Median- gegen Tail-Latenz},
    xlabel={Median-Latenz p50 (ns/op)},
    ylabel={Tail-Latenz p99 (ns/op)},
    grid=both,
    enlargelimits=0.05,
    xmode=log,
    ymode=log,
...
\caption{Pareto-Streuung: Median- gegen Tail-Latenz (ein Punkt je Konfiguration und Op-Art; Diagonale = kein Tail-Aufschlag)}
\end{figure}
