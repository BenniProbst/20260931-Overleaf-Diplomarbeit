...
%% als Aliase lesbar; Default gesetzt, Widerspruch genügt.
  ...
  \texttt{genus()} einer Hybrid-Binary meldet dagegen das geerbte Ziel-Genus, die Umleitung bleibt
...
%% Widerspruch genügt.
  ...
  aktivierten Katalogen rechnet (vgl.\ Abschnitt~\ref{sec:mess-chain}).
