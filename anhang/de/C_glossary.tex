...
%% INTERN-272: KA-137
  ...
  \texttt{release} (Auslieferung ohne Messfühler); der modus-spezifische Ablauf von \texttt{compare} und
  \texttt{release} ist für spätere Haupt-Wellen vorgesehen. Der Arbeitsmodus ist eine Unter-Achse des
...
%% INTERN-272: KA-149
  ...
  prüft (unter \texttt{--debug} zusätzlich der Standard-Testsatz des Tier-Interfaces; Anhang~\ref{app:interfaces}).
