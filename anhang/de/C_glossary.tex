...
%% (Bestand 3/4 = Lager-Vollausbau) steht im Lemma Lager; Default gesetzt, Widerspruch genügt.
  ...
  Durchführungs-Stand: Die Naht schreibt die CSV-Projektion als eine flache Datei; die Baumform ist ein
  offener Bauposten (Abschnitt~\ref{sec:eval-dataflow}).
  ...
  (50 bis 75~\%) $\to$ Vector$\langle$u16,u16$\rangle$ (über 75~\%); der Prüfling schaltet derzeit nach
  diesen festen Schwellen um, die plattform-kalibrierten Regeln sind Plan-Setzung (Teilfrage FF3.a,
...
%% Alias desselben Lemmas; Default gesetzt, Widerspruch genügt.
  ...
  auswertbar~\cite{graham2009missing}. Alias: Doktrin der ausgewiesenen Nichterhebung; im Code das
...
%% als Aliase lesbar; Default gesetzt, Widerspruch genügt.
  ...
  nach außen transparent. Der Genus ist die einzige gepflegte Quelle der Einordnung; je andockendem
  Genus gibt es genau ein Prüf-Dock (fünf Docks für SearchAlgorithm, Set, Sequence, Adapter und
  View), während das klassifizierende Genus FunctionInterfaceReroute keines hat und seine Binaries
  am Dock des gemeldeten Ziel-Genus andocken. Alias: Gattungs-Unterklasse, Tier-Unterklasse.
