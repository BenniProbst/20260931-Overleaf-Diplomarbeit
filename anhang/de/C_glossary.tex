...
%% Alias desselben Lemmas; Default gesetzt, Widerspruch genügt.
  ...
  ist die Ableitung des Genus (eine gepflegte Quelle) und wird über ein gattungsunabhängiges
  C-Symbol ermittelt (das Symbol trägt für jede Gattung denselben Namen). In der Produktlinien-Lesart ist die Gattung die
...
%% als Aliase lesbar; Default gesetzt, Widerspruch genügt.
  ...
  \texttt{AnatomyGenus}). Sechs Genera: SearchAlgorithm unter Map --- im Metapher-Kanon dieser Arbeit das \enquote{Säugetier} mit
  der vollen Achtzehn-Achsen-Anatomie ---, Set, Sequence, Adapter und View unter Container
  (im Metapher-Kanon die Tierklassen \enquote{Vogel}, \enquote{Reptil}, \enquote{Wirbelloses} und
  \enquote{Pflanze} als Lebewesen mit je eigenem, übersetzungsstatisch festgelegtem Achsen-Satz; siehe
  \emph{Metapher-Kanon}) sowie
...
%% abweichende Beschriftung und kein Thesis-Gegenstand; Default Owner-Wort, Widerspruch genügt.
  ...
  einer Gattung (die Tierklassen als Beispiele je Genus: \enquote{Säugetier} $=$ SearchAlgorithm,
  \enquote{Vogel}, \enquote{Reptil}, \enquote{Wirbelloses} und \enquote{Pflanze} $=$ die vier
  Container-Genera Set, Sequence, Adapter und View); Virus $=$ achsenloses Graph-Modul; Blut $=$ das flüssige Organ, das alle
